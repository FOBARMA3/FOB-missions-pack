...
<br/><br/><font color='#6c7169'>le log Wolfpack est un carnet qui reprend toutes les coms entre Wolf et TOC<br/>
Les messages sont enregistrés dès qu'ils apparaissent à l'écran.Tous les messages sont data-timés et sauvegardés dans leur ordre d'apparence.</font>
<br/><br/>
"]];

...
{  
	class End1
	{
		...
		subtitle = "Operation Kajman Fire";
		description = "Jetson: Bien joué les gars. Whisky et médailles vous attendent à votre retour!";
		pictureBackground = "Img\intro_day2.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
	...
	class End2
	{
		...
		subtitle = "Operation Kajman Fire";
		description = "Jetson: Maintenant nous devons négocier avec le Kajman dans la bataille. Mauvaises nouvelles commandant!";
		pictureBackground = "Img\intro_day2.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};
	class Killed
	{
		...
		subtitle = "Operation Kajman Fire";
		description = "Jetson: Wolf 1,2 et 3 sont morts au combat. Echec de la mission...";
		pictureBackground = "Img\intro_day2.paa"; // eg. "img\yourpicture.jpg" no picture? use "";
		pictureColor[] = {0.0,0.3,0.6,1}; // Overlay color
	};	
};
